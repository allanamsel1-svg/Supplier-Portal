...
(function () {
  ...
  var NAV = [
    ...
    { section: 'Operations', items: [
      ...
      { icon: '📦', label: 'Warehouse',         panel: 'warehouse',      badge: 'BETA' },
      { icon: '💰', label: 'Accounting',        panel: 'accounting',     badge: 'BETA' },
    ...
    { section: 'Factories', items: [
      ...
      { icon: '⚠',  label: 'Pending Reviews',  panel: 'pending-cats',   loaders: ['loadPendingCats'],        count: 'cnt-pending-cats' },
    ...
    { section: 'Communications', items: [
      ...
      { icon: '📬', label: 'Sourcing',   href: 'communications.html' },
      { icon: '💼', label: 'Sales',      href: 'communications.html' },
      { icon: '🎨', label: 'Graphics',   href: 'communications.html' },
      { icon: '💰', label: 'Accounting', href: 'communications.html' },
      { icon: '🚚', label: 'Logistics',  href: 'communications.html' },
    ]},
    { section: 'RFQ & Products', items: [
      { icon: '📋', label: 'RFQs',              panel: 'rfq',            count: 'cnt-rfq' },
      { icon: '🧪', label: 'Product Dev',       panel: 'pd',             loaders: ['loadPDItems'],            count: 'cnt-pd' },
    ]},
