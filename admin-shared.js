...
(function () {
  ...
  var NAV = [
    ...
    { section: 'Communications', items: [
      ...
      { icon: '📬', label: 'Sourcing',          panel: 'inbox-sourcing' },
      { icon: '💼', label: 'Sales',             panel: 'inbox-sales' },
      { icon: '🎨', label: 'Graphics',          panel: 'inbox-graphics' },
      { icon: '💰', label: 'Accounting',        panel: 'inbox-accounting' },
      { icon: '🚚', label: 'Logistics',         panel: 'inbox-logistics' },
    ]},
